-- Fix profile-photos storage bucket and policies (Final Version)
-- This script handles existing policies and ensures proper configuration
...
-- Drop ALL existing policies for profile-photos to avoid conflicts
